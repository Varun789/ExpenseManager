...
public class DBHelper extends SQLiteOpenHelper {
   ...
   // public static final String EXPENSE_COLUMN_CATEGORY_IDENTIFIER = "identifier";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createTable = "create table Category (id integer primary key AUTOINCREMENT, category_name);";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS "+EXPENSE_TABLE_NAME +EXPENSE_TABLE_ADD);
        onCreate(db);
    ...
    public ArrayList<String> getAllCategory() {
        ...
        res.moveToFirst();
//.isAfterlast returns true when we reach the last element
